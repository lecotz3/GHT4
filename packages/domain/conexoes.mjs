...
function lerRede() {
  ...
  try {
    const cru = ARMAZENAMENTO.local().getItem(CHAVE_REDE);
...
function gravarRede(membros) {
  ...
  cacheAnalise = {};
  try {
    ARMAZENAMENTO.local().setItem(CHAVE_REDE, JSON.stringify(membros));
    return true;
  } catch {
    return false;
  }
...
const REDE_DEMONSTRACAO = [
  {
    ...
    setores: ['Químicos'],
    subsetores: ['Petroquímica básica e intermediários', 'Distribuição e trading químico'],
    historico: [{ empresa: 'Braskem', cargo: 'Gerente de Planejamento Comercial', de: '2014', ate: '2018' }],
    contatos: [{ nome: 'Contato 1 (fictício)', empresa: 'Unipar Carbocloro S.A.', cargo: 'Diretor Financeiro', relacao: 'ex-colega' }],
    formacao: [{ instituicao: 'Instituição X', curso: 'Engenharia Química', ano: '2008' }],
  },
  {
    id: 'demo2', nome: 'Sócia B (fictícia)', cargo: 'Sócia · Execução', area: 'GHT4 Advisory', uf: 'RJ',
    setores: ['Químicos'],
    subsetores: ['Inorgânicos e gases industriais'],
    historico: [],
    contatos: [{ nome: 'Contato 2 (fictício)', empresa: 'Unipar Carbocloro S.A.', cargo: 'Conselheiro', relacao: 'conselho compartilhado' }],
    formacao: [],
  },
  {
    id: 'demo3', nome: 'Diretor C (fictício)', cargo: 'Diretor', area: 'Grupo GHT4 (não Advisory)', uf: 'SP',
    setores: ['Químicos'],
    subsetores: ['Fertilizantes e nutrição vegetal', 'Domissanitários e produtos de limpeza'],
    historico: [{ empresa: 'Fertilizantes Heringer S.A.', cargo: 'Diretor de Operações', de: '2019', ate: '2023' }],
    contatos: [{ nome: 'Contato 3 (fictício)', empresa: 'Bombril S.A.', cargo: 'Diretor Industrial', relacao: 'ex-colega' }],
    formacao: [],
  },
];
